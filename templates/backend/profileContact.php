...
<table class="form-table">
    ...
    <tr>
        <th><label for="<?php echo User_Util::POST_ATTRIBUT_ADRESSE; ?>">Adresse eures regelm&auml;&szlig;igen Treffpunkts</label></th>
        <td>
    ...
    <tr>
        <th><label for="<?php echo User_Util::POST_ATTRIBUT_IGEL; ?>">Logo eurer Gruppe</label></th>
        <td>
            <?php
